...
public class StartFullTest extends BaseActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_start_full_test);
    ...
    public void directToChoice(View view) {
        Intent intent = new Intent(this,activity_choice_landing.class);
                ...
                googleSignInClient.signOut()
                        .addOnCompleteListener(new OnCompleteListener<Void>() {
                            ...
                            public void onComplete(@NonNull Task<Void> task) {
                                i = new Intent(StartFullTest.this, SignInPage.class);
                                startActivity(i);
                            }
                        });
                break;
